...
/** Anonymous volumes have 64-char hex names (auto-generated by Docker) */
const ANONYMOUS_VOLUME_PATTERN = /^[a-f0-9]{64}$/;
const isAnonymousVolume = (name: string) => ANONYMOUS_VOLUME_PATTERN.test(name);
...
export default function VolumesPage() {
  ...
  const anonymousUnusedVolumes = useMemo(
    () => allUnusedVolumes.filter((vol) => isAnonymousVolume(vol.name)),
    [allUnusedVolumes]
  );
